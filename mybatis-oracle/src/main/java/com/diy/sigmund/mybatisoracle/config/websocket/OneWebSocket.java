package com.diy.sigmund.mybatisoracle.config.websocket;

/**
 * @author ylm-sigmund
 * @since 2021/2/25 21:25
 */
 ...
 * @author ylm-sigmund
 * @since 2021/2/25 21:23
 */
// @Slf4j
@ServerEndpoint("/one/{userId}")
@Component
public class OneWebSocket {
    ...
    public void onError(Session session, Throwable error) {
        LOGGER.error("用户错误:" + this.userId + ",原因:", error);
    }
    ...
    public static void sendInfo(String message, @PathParam("userId") String userId) {
        ...
        if (StringUtils.isNotBlank(userId) && webSocketMap.containsKey(userId)) {
            try {
                ...
                LOGGER.error("sendInfo error, 用户" + userId, e);
            }
        } else {
